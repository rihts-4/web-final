...
export function SignUpPage({ onComplete, onBack }: SignUpPageProps) {
  ...
  return (
    <div
      ...
      style={{ background: "#F4F0E6", fontFamily: "'Nunito', sans-serif" }}
    >
      {/* Background blobs */}
            ...
            <div className="flex gap-1.5">
              {["info", "interests"].map((s, i) => (
                <div
                  ...
                  style={{ background: (step === "info" && i === 0) || step === "interests" ? "#6B8F5E" : "rgba(42,42,37,0.12)" }}
                />
              ))}
            </div>
            <p className="text-[11px] mt-1" style={{ color: "#B5B0A4", fontWeight: 500 }}>
          ...
          {step === "info" ? (
            <>
              ...
              <div className="flex items-center gap-2 mb-1">
                <Leaf size={18} strokeWidth={2.2} style={{ color: "#6B8F5E" }} />
                <h2 className="text-foreground text-[22px]" style={{ fontWeight: 800 }}>Plant your seed</h2>
              </div>
              <p className="text-[14px] mb-6" style={{ color: "#7D7D72" }}>
              ...
              <div className="flex flex-col gap-3 mb-6">
                ...
                <div className="relative">
                  <User size={15} strokeWidth={2.2} className="absolute left-3.5 top-1/2 -translate-y-1/2" style={{ color: "#B5B0A4" }} />
                  <input
                    type="text"
                ...
                {/* Handle */}
                <div className="relative">
                  <AtSign size={15} strokeWidth={2.2} className="absolute left-3.5 top-1/2 -translate-y-1/2" style={{ color: "#B5B0A4" }} />
                  <input
                    type="text"
              ...
              <button
                ...
                style={{
                  ...
                  color: "#FDFAF4",
                  fontWeight: 800,
                  boxShadow: "0 6px 18px rgba(107,143,94,0.35)",
                }}
              >
                Continue →
              </button>
            ...
            <>
              ...
              <div className="flex items-center gap-2 mb-1">
                ...
                <h2 className="text-foreground text-[22px]" style={{ fontWeight: 800 }}>Pick your garden</h2>
              </div>
              <p className="text-[14px] mb-5" style={{ color: "#7D7D72" }}>
                ...
                {INTERESTS.map(({ label, emoji }) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {on && <span className="ml-auto text-[14px]" style={{ color: "#6B8F5E" }}>✓</span>}
                    </button>
                  );
                })}
              </div>
      ...
      <div className="relative z-10 mt-5 flex gap-4">
        {["Terms", "Privacy", "About"].map((item) => (
          <a key={item} href="#" className="text-[12px] hover:underline" style={{ color: "#B5B0A4" }}>
            {item}
          </a>
        ))}
      </div>
