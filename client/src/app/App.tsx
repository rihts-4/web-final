...
export default function App() {
  ...
  const [posts, setPosts] =
    useState<ThoughtPost[]>(INITIAL_POSTS);
  const [activeNav, setActiveNav] = useState("home");
  const [showCompose, setShowCompose] = useState(false);
  const [showOnboarding, setShowOnboarding] = useState(false);
  const [replyPost, setReplyPost] =
    useState<ThoughtPost | null>(null);
  ...
  const handleRepost = (id: string) =>
    setPosts((prev) =>
      prev.map((p) =>
        p.id === id ? { ...p, reposted: !p.reposted } : p,
      ),
    );
      ...
      const notifs = [
        {
          ...
          time: "2h",
          avatar: INITIAL_POSTS[0].user.avatar,
        },
        {
          emoji: "👁",
          user: "Rowan Ashby",
          ...
          time: "4h",
          avatar: INITIAL_POSTS[1].user.avatar,
        },
        {
          emoji: "🔁",
          user: "Zara Finch",
          ...
          time: "6h",
          avatar: INITIAL_POSTS[2].user.avatar,
        },
        {
          emoji: "💬",
          user: "Felix Osei",
          ...
          time: "8h",
          avatar: INITIAL_POSTS[3].user.avatar,
        },
        {
          emoji: "❤️",
          user: "Mila Voss",
          action: "liked your thought",
          time: "1d",
          avatar: INITIAL_POSTS[4].user.avatar,
        },
      ];
      return (
        <div
